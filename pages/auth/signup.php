...
<div class="mx-auto max-w-md">
    ...
    <p class="mt-2 text-gray-600">역할 선택 후 정보를 입력하세요.</p>
    <?php if ($error): ?>
    ...
    <form class="mt-6 space-y-4" action="<?= $base ?>/auth/signup" method="post">
        <div>
            <span class="block text-sm font-medium text-gray-700">역할 선택</span>
        ...
        <div class="flex items-start gap-2">
            ...
            <label for="terms" class="text-sm text-gray-700">서비스 이용약관 및 개인정보 처리방침에 동의합니다.</label>
        </div>
        <button type="submit" class="flex min-h-[44px] w-full items-center justify-center rounded-lg bg-primary font-medium text-white hover:opacity-90">회원가입</button>
    </form>
