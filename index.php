...
$map = [
    ...
    'api/admin/approve-manager' => 'api/admin/approve-manager.php',
    'api/admin/reject-manager' => 'api/admin/reject-manager.php',
    ...
    'debug-signup' => 'debug-signup.php',
    'check-signup-file' => 'check-signup-file.php',
    ...
    'manager/signup-complete' => 'pages/manager/signup-complete.php',
    ...
    'admin/manager-applications' => 'pages/admin/manager-applications.php',
